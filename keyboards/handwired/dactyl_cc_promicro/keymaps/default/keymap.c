...
// The default Kinesis Advantage Keycaps map to this configuration, notice that the thumb clusters dont match exactly in this version of the wiring guide.
// KC_EQL , KC_1  , KC_2    , KC_3   , KC_4   , KC_5   ,                               KC_6  , KC_7   , KC_8   , KC_9   , KC_0   , KC_MINS ,
// KC_TAB , KC_Q  , KC_W    , KC_E   , KC_R   , KC_T   ,                               KC_Y  , KC_U   , KC_I   , KC_O   , KC_P   , KC_BSLS ,
// KC_CAPS, KC_A  , KC_S    , KC_D   , KC_F   , KC_G   ,                               KC_H  , KC_J   , KC_K   , KC_L   , KC_SCLN, KC_QUOT ,
// KC_LSPO, KC_Z  , KC_X    , KC_C   , KC_V   , KC_B   ,                               KC_N  , KC_M   , KC_COMM, KC_DOT , KC_SLSH, KC_RSPC ,
// _______, KC_GRV, KC_BSLS , KC_LEFT, KC_RGHT, KC_BSPC,                               KC_SPC, KC_DOWN, KC_UP  , KC_LBRC, KC_RBRC, _______ ,
//                                        KC_LALT, KC_DEL, KC_END,           KC_PGDN ,KC_ENT, KC_RGUI,
//                                                         KC_HOME,          KC_PGUP,
//                                                         KC_LCTL,          KC_RALT
